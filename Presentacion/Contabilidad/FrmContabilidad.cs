using Presentacion.Contabilidad.Periodo;
...
namespace Presentacion.Contabilidad
{
    public partial class FrmContabilidad : Form
    {
        ...
        {
            if (this.PnlAplicacion.Controls.Count > 0)
                this.PnlAplicacion.Controls.RemoveAt(0);
            Form fh = FormHijo as Form;
            fh.TopLevel = false;
            fh.Dock = DockStyle.Fill;
            this.PnlAplicacion.Controls.Add(fh);
            this.PnlAplicacion.Tag = fh;
            fh.Show();
        }
        ...
        private void FrmContabilidad_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }
        ...
        {
            FormularioHijo(new FrmPeriodo_Lista());
        }
